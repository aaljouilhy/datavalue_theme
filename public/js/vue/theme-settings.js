        ...
        $('#page-login').each(function () {
            ...
            frappe.call({
                ...
                callback: function (response) {
                    ...
                    if (settings.full_page_background == '1' && settings.enable_background == '1') {
                    ...
                    if (settings.background_type == 'Single Photo' && settings.enable_background == '1') {
                        ...
                        `);
                        $('head').append(`
                            <link rel="stylesheet" class="login-slideshow-css" href="/assets/datavalue_theme/plugins/owl-carousel/owl.carousel.css">
                            <link rel="stylesheet" class="login-slideshow-css" href="/assets/datavalue_theme/plugins/owl-carousel/owl.theme.css">
                            <link rel="stylesheet" class="login-slideshow-css" href="/assets/datavalue_theme/plugins/owl-carousel/owl.transitions.css">
                        `);
                        $('body').append(`
                            <script class="login-slideshow-js" src="/assets/datavalue_theme/plugins/owl-carousel/owl.carousel.min.js"></script>
                        `);
                        setTimeout(function () {
